...
namespace GeoFramework.Gps.IO
{
    ...
    public sealed class BluetoothDevice : NetworkDevice, IEquatable<BluetoothDevice>
    {
        ...
        public static void DiscoverDevices(bool isCacheFlushed)
        {
            ...
            DeviceDiscoveryThread.Name = "GPS.NET Bluetooth Device Discovery Thread (http://www.geoframeworks.com)";
 ...
 || !_IsDeviceDiscoveryThreadAlive
        ...
        public void DiscoverServices(bool isCacheFlushed)
        {
            ...
            _ServiceDiscoveryThread.Name = "GPS.NET Bluetooth Service Discovery on " + Name + " (http://www.geoframeworks.com)";
