...
namespace GeoFramework.Gps.Controls
{
	...
	public sealed class SatelliteViewer : PolarControl
	{
			...
			: base("GeoFramework Multithreaded Satellite Viewer Control (http://www.geoframeworks.com)")
		{
            ...
            GeoFramework.Gps.IO.Devices.SatellitesChanged += new SatelliteCollectionEventHandler(Devices_CurrentSatellitesChanged);
            GeoFramework.Gps.IO.Devices.BearingChanged += new EventHandler<AzimuthEventArgs>(Devices_CurrentBearingChanged);
#endif
		}
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GeoFramework.Gps.IO.Devices.SatellitesChanged += new EventHandler<SatelliteListEventArgs>(Devices_CurrentSatellitesChanged);
                    GeoFramework.Gps.IO.Devices.BearingChanged += new EventHandler<AzimuthEventArgs>(Devices_CurrentBearingChanged);
                }
            }
            catch
		...
		protected override void OnInitialize()
		{
            ...
            else
            {
                if (_IsUsingRealTimeData)
                {
                    ...
                    _Satellites = GeoFramework.Gps.IO.Devices.Satellites;
                }
            }
			...
			set
			{
				...
				if (_IsUsingRealTimeData)
				{
					...
					if(this._RotationOrientation == RotationOrientation.TrackUp)
						Rotation = new Angle(-GeoFramework.Gps.IO.Devices.Bearing.DecimalDegrees);
				}
				else
				{
					_Satellites.Clear();
