...
Public Class MainForm
    ...
    Private emulator As VirtualDevice = VirtualDevice.Default
...
#Region "  Other Form Control Events  "
    ...
    Private Sub simulateCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles simulateCheckBox.CheckedChanged
        If simulateCheckBox.Checked Then
            If Not Devices.GpsDevices.Contains(emulator) Then
                Devices.GpsDevices.Add(emulator)
            End If
        Else
            If Devices.GpsDevices.Contains(emulator) Then
