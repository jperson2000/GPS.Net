...
namespace GeoFramework.Gps.Controls
{
    ...
    public sealed class Altimeter : PolarControl
    {
		...
		public Altimeter()
			: base("GeoFramework Multithreaded Altimeter Control (http://www.geoframeworks.com)")
		{
#if !PocketPC
			...
			_InterpolationThread.Name = "GeoFramework Altimeter Needle Animation Thread (http://www.geoframeworks.com)";
...
//            GeoFramework.Gps.IO.Devices.AltitudeChanged += new EventHandler<DistanceEventArgs>(Devices_CurrentAltitudeChanged);
//#endif
        }
...
#endif
                            Value = GeoFramework.Gps.IO.Devices.Altitude;
