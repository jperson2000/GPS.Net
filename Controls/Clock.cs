...
//#endif
		...
		/* The constructor provides a name for the control.  This name is used as the
			...
			*/
		public Clock() 
			: base("GeoFramework Multithreaded Clock Control (http://www.geoframeworks.com)")
		{		
...
//            GeoFramework.Gps.IO.Devices.UtcDateTimeChanged += new EventHandler<DateTimeEventArgs>(Devices_CurrentUtcDateTimeChanged);
//#endif
		}
...
//#endif
		...
		{
			/* The GeoFramework comes with a special class named "PolarGraphics," which works
			...
			set
			{
				...
				switch(pDisplayMode)
				{
...
#if !PocketPC || Framework20
						ClockThread.Name = "GeoFramework Clock Update Thread (http://www.geoframeworks.com)";
					...
					case ClockDisplayMode.SatelliteDerivedTime:
						...
						Value = GeoFramework.Gps.IO.Devices.UtcDateTime.ToLocalTime();
						break;
