    ...
    Private Sub suggestionListView_ItemActivate(ByVal sender As Object, ByVal e As EventArgs) Handles suggestionListView.ItemActivate
        ...
        Select command
            ...
            Case "GpsidIncorrectPort"
                ...
                If MessageBox.Show("Would you like to configure the GPS Intermediate Driver (GPSID) to use a better device?", "Update Settings", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If MessageBox.Show("The GPSID has been updated to use \"" + preferredSerialDevice.Port + " \ " at baud rate \"" + preferredSerialDevice.BaudRate.ToString() + " \ ".  Do you want to verify that it's working?", "Confirm Settings", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Case "BluetoothCreateVirtualPort"
                If MessageBox.Show("Setting up a virtual serial port can make your Bluetooth GPS device available to programs.  Would you like to set this up now?", "Virtual Serial Port", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Case "TurnBluetoothOn"
                ...
                If MessageBox.Show("Would you like to turn Bluetooth on now?", "Enable Bluetooth", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If Devices.IsBluetoothEnabled Then
                        ...
                        If MessageBox.Show("Bluetooth is now enabled.  Would you like to look for GPS devices again?", "Bluetooth Enabled", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
