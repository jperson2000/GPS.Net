...
namespace GeoFramework.Gps.IO
{
    ...
    public abstract class Device : IDisposable, IFormattable, IComparable<Device>
    {
        ...
        public DeviceAnalysis Test()
        {
            ...
            log.Append("------------------------------------------------------------------------------------------------------------------------------\r\n");
            log.Append("GPS.NET 3.0 Diagnostics    Copyright © 2009  GeoFrameworks, LLC\r\n");
            log.Append("                                   http://www.geoframeworks.com\r\n");
            log.Append("\r\n");
        ...
        public void BeginDetection()
        {
            ...
            _DetectionThread.Name = "GPS.NET Protocol Detector on " + Name + " (http://www.geoframeworks.com)";
    ...
    public class DeviceAnalysis
    {
        ...
        {
            return SendAnonymousLog(new Uri("http://www.geoframeworks.com/GPSDeviceDiagnostics.aspx"));
        }
