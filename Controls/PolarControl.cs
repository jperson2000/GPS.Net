...
namespace GeoFramework.Drawing
{
	...
	public abstract class PolarControl : DoubleBufferedControl 
	{
...
#if !PocketPC
		private PolarControlEffect _Effect = PolarControlEffect.Glass;
#endif
        ...
        // Glass reflection
        LinearGradientBrush GlassReflectionBrush;
        RectangleF GlassReflectionRectangle;
#endif
		...
		protected PolarControl() 
            : this("GeoFrameworks Polar Control (http://www.geoframeworks.com)")
		{}
            ...
            : base(threadName)
        {
			...
			InterpolationThread.Name = "GeoFramework Rotation Interpolation Thread (http://www.geoframeworks.com)";
                ...
                {                  
                    ...
                    else if (value.DecimalDegrees >= Current - 180.0)
                    {
                        ...
                        if (!IsClockwise)
                        {
                            ...
                            RotationInterpolator.Minimum = FinalTarget;
                        }
                        else
                        {
